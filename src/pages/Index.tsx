      ...
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <img alt="Slimzyo Logo" className="h-16 w-16 md:h-48 md:w-48" src="/lovable-uploads/561b0b6c-8b33-4d1b-9172-33574ee149c7.png" />
        ...
        <section className="mb-8 md:mb-12">
          <Card className="bg-gradient-to-r from-green-500 to-blue-500 text-white">
            <CardHeader className="text-center px-4 py-6">
              ...
              <CardDescription className="text-green-100 text-base md:text-lg leading-relaxed">Súhrn overených poznatkov, ktoré fungujú a umožnia ti pochopiť základy zdravého chudnutia. 
